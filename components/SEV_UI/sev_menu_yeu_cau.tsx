...
export default function SevMenuYeuCau() {
    ...
    <View style={[styles.card, { backgroundColor: colors.card }]}>
      ...
      <View style={{ flexDirection: 'row', gap: 5 }}>
        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>Xác nhận yêu cầu</Text>
        </TouchableOpacity>
        <TouchableOpacity style={{
          backgroundColor: '#FEA13B', marginTop: 8,
          alignSelf: "flex-end",
          paddingVertical: 8,
          ...
          <Text style={styles.buttonText}>Liên hệ DN</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
