...
export default function dhtk_main() {
    ...
    return (
        <View>
            ...
            <View>
                ...
                <PieChart
                    data={[
                        { name: 'Đang diễn ra', population: 60, color: '#15ad15ff', legendFontColor: '#7F7F7F', legendFontSize: 15 },
                        { name: 'Sắp diễn ra', population: 30, color: '#edba11ff', legendFontColor: '#7F7F7F', legendFontSize: 15 },
                        { name: 'Đã kết thúc', population: 10, color: '#c52222ff', legendFontColor: '#7F7F7F', legendFontSize: 15 },
                    ]}
                    width={width - 20}
                    height={220}
                    chartConfig={{
